...
const CenterScrollArea = React.forwardRef<
...
CenterScrollArea.displayName = ScrollAreaPrimitive.Root.displayName;

const CenterScrollBar = React.forwardRef<
...
CenterScrollBar.displayName =
  ScrollAreaPrimitive.ScrollAreaScrollbar.displayName;

export { CenterScrollArea, CenterScrollBar };
