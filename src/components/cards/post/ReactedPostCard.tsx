      ...
      <div className="flex flex-col sm:flex-row border-l sm:border-none w-full">
        ...
        <div className="p-2.5 py-3 flex justify-between gap-2 w-full">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex justify-start items-center gap-1 text-gray-500 text-base flex-wrap select-none">
              <span>Reaction: </span>
              <Image
                src={"/reaction-icons/clap.png"}
                alt=""
                width={30}
                height={30}
          ...
          {showThreeDot && (
            <div className="self-center flex-shrink-0">
              <PostCardCTA postType={"REACTED_POST_CARD"} />
            </div>
          )}
        </div>
      </div>
...
export default ReactedPostCard;
