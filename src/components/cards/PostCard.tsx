...
import PostCardCTA from "../actions/PostCardCTA";
...
const PostCard = () => {
  ...
  return (
    <div className="shadow-xl w-full max-w-sm border border-gray-500/10 rounded-sm">
      <Link href={"/"} className="flex justify-start items-center gap-2 p-2.5">
        ...
        <h4 className="text-primary/80 text-base font-semibold line-clamp-1 overflow-hidden text-ellipsis">
          Developer Hub BD
        </h4>
      </Link>
      <Link href={"/"}>
